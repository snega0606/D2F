...
<body>
    <div class="product-form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="email" name="email" required> <!-- Assuming email input type -->
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $checkEmailQuery->bind_param("d", $email);
        ...
        if ($result->num_rows > 0) {
            ...
            $insertQuery = $conn->prepare("INSERT INTO product (id, product_type, product_name, email, amount_per_kg, discount_per_kg, img) VALUES (?,?, ?, ?, ?, ?, ?)");

            if (!$insertQuery) {
                die("Error preparing insert statement: " . $conn->error);
            }

            $insertQuery->bind_param("ssssdss",$id, $productType, $productName, $email, $amountPerKg, $discountPerKg, $targetFile);
