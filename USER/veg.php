...
<body>
    ...
    <div class="product-list">
        <h2>Vegetables Product List</h2>
        <div class="bill">
    <button onclick="window.location.href='billing2.php'"> BUY</button>
                </div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM product WHERE product_type = 'vegetables'";
    ...
    <button onclick="window.location.href='user_product.php'"> HOME</button>
</body>
</html>
