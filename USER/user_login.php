...
<head>
    ...
    <style>
        body {
            ...
            background: url('templatemo_carousel_bg_s.jpg') center/cover no-repeat;
            margin: 0;
            padding: 0;
            display: flex;
            align-items: center;
  ...
  <div class="login-container">
        ...
        <br>
            <div class="forgot-password">
                <a href="user_forget.php">Forgot Password?</a>
            </div>
            <input type="submit" value="Login">
        </form>
        <div class="signup-link">
            <p>Don't have an account? <a href="user_sign.html"><b>Sign Up</b></a></p>
        </div>
        <div class="home">
