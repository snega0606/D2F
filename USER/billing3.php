...
<body>
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <div class="form-group">
                <label for="fruits">Nuts</label>
                <select id="fruits" name="fruits" onchange="updateAmount()">
                    <option value="">Select Nuts</option>
                    <option value="Bananna" data-price="200">Cashew Nuts - ₹200</option>
                    <option value="Apple" data-price="150">Almond - ₹150</option>
                    <option value="Jackfruit" data-price="60">Peanut - ₹60</option>
                </select>
            </div>
            <div class="form-group">
