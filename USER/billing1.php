        ...
        <form action="#" method="post">
            ...
            <div class="form-group">
                ...
                <select id="fruits" name="fruits" onchange="updateAmount()">
                    ...
                    <option value="Bananna" data-price="50">Bananna - ₹50</option>
                    <option value="Apple" data-price="100">Mango - ₹100</option>
                    <option value="Jackfruit" data-price="200">Jackfruit - ₹200</option>
                </select>
            </div>
            <div class="form-group">
